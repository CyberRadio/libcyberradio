...
#ifndef INCLUDED_LIBCYBERRADIO_NDR651_STATUSRECEIVER_H_
#define INCLUDED_LIBCYBERRADIO_NDR651_STATUSRECEIVER_H_
...
namespace LibCyberRadio
{
	...
	namespace NDR651
	{
		 ...
		 */
		class StatusReceiver: public LibCyberRadio::Thread, public LibCyberRadio::Debuggable
		{
			public:
				/*!
				 * \brief Constructs a StatusReceiver object.
				...
				/*!
				 * \brief Destroys a StatusReceiver object.
				 */
				...
				void blockUntilAvailable(unsigned int numSamples);
			...
			private:
				...
				// Synchronization and signal mechanisms
...
#endif /* INCLUDED_LIBCYBERRADIO_NDR651_STATUSRECEIVER_H_ */
