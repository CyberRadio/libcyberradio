...
#ifndef INCLUDED_LIBCYBERRADIO_DRIVER_NDR810_RADIOHANDLER_H
#define INCLUDED_LIBCYBERRADIO_DRIVER_NDR810_RADIOHANDLER_H
...
namespace LibCyberRadio
{
    ...
    namespace Driver
    {
    	...
    	namespace NDR810
		{
             ...
             *
             * \section Tuners_NDR810 Tuners
             *
             * The NDR810 has eight tuners, indexed 1-8.
             ...
             *
             * \section WBDDCs_NDR810 WBDDCs
             *
             * The NDR810 has eight WBDDCs, indexed 1-8.  Each WBDDC corresponds to the
             ...
             * </table>
             *
             * \section WbddcGroups_NDR810 WBDDC Groups
             *
             * The NDR810 has four WBDDC groups, indexed 1-4.
             *
             * Configuration dictionary elements:
             ...
             *
             * \section NBDDCs_NDR810 NBDDCs
             *
             * The NDR810 has 32 NBDDCs, indexed 1-32.
             *
             * Configuration dictionary elements:
             * * "enable": Whether or not this DDC is enabled [Boolean/integer/string]
             * * "rateIndex": Rate index [integer/string]
             ...
             * </table>
             *
             * \section NbddcGroups_NDR810 NBDDC Groups
             *
             * The NDR810 has eight NBDDC groups, indexed 1-8.
             *
             * Configuration dictionary elements:
             * * "enable": Whether or not this DDC group is enabled [Boolean/integer/string]
             * * "members": Comma-separated list of NBDDCs in this group [string]
             *
             * \section Transmitters_NDR810 Transmitters
             *
             * The NDR810 has no transmission capability.  Methods that affect
             * transmitters are meaningless on this radio.
             *
             * \section DUCs_NDR810 DUCs
             *
             * The NDR810 has no transmission capability.  Methods that affect
             * DUCs are meaningless on this radio.
             *
             * \section DataPorts_NDR810 Data Ports
             *
             * The NDR810 has two 10GigE data ports, indexed 1-2.
             *
             * Configuration dictionary items:
             ...
             *
             * \section VitaEnable_NDR810 VITA 49 Enabling Options for DDCs
             *
             * <table>
...
#endif /* INCLUDED_LIBCYBERRADIO_DRIVER_NDR810_RADIOHANDLER_H */
