...
#ifndef INCLUDED_LIBCYBERRADIO_DRIVER_NDR810_WBDDCCOMPONENT_H
#define INCLUDED_LIBCYBERRADIO_DRIVER_NDR810_WBDDCCOMPONENT_H
...
namespace LibCyberRadio
{
    ...
    namespace Driver
    {
		...
		namespace NDR810
		{
			...
			/**
			 * \brief WBDDC component class for the NDR810.
			 *
...
#endif // INCLUDED_LIBCYBERRADIO_DRIVER_NDR810_WBDDCCOMPONENT_H
