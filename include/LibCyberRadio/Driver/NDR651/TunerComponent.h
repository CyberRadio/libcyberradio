 ...
 * \brief Defines the tuner interface for the NDR651.
 * \author DA
 * \author NH
 * \author MN
...
#ifndef INCLUDED_LIBCYBERRADIO_DRIVER_NDR651_TUNERCOMPONENT_H
#define INCLUDED_LIBCYBERRADIO_DRIVER_NDR651_TUNERCOMPONENT_H
...
namespace LibCyberRadio
{
    ...
    namespace Driver
    {
    	...
    	namespace NDR651
		{
			...
			/**
			 * \brief Tuner component class for the NDR651.
			 *
...
#endif // INCLUDED_LIBCYBERRADIO_DRIVER_NDR651_TUNERCOMPONENT_H
