 ...
 * \brief Defines the NBDDC interface for the NDR651.
 * \author DA
 * \author NH
 * \author MN
...
#ifndef INCLUDED_LIBCYBERRADIO_DRIVER_NDR651_NBDDCCOMPONENT_H
#define INCLUDED_LIBCYBERRADIO_DRIVER_NDR651_NBDDCCOMPONENT_H
...
namespace LibCyberRadio
{
    ...
    namespace Driver
    {
    	...
    	namespace NDR651
		{
			...
			/**
			 * \brief NBDDC component class for the NDR651.
			 *
...
#endif // INCLUDED_LIBCYBERRADIO_DRIVER_NDR651_NBDDCCOMPONENT_H
