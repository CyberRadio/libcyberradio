        ...
        namespace NDR324
        {
            ...
            TunerComponent::TunerComponent(int index,
                ...
                ::LibCyberRadio::Driver::TunerComponent(
                        /* const std::string& name */ (boost::format("NDR324-TUNER%02d") % \
                                index).str(),
                        /* int index */ index,
                        ...
                        /* int filter */ filter)
            {
                this->debug("[NDR324::TunerComponent] index - %d\n", index);
            ...
            void TunerComponent::queryConfiguration()
            {
                ...
                this->debug("[NDR324] [TunerComponent::queryConfiguration] Returning\n");
            }
