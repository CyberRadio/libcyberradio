...
namespace LibCyberRadio
{
    namespace Driver
    {
        ...
        bool NbddcGroupComponent::enable(bool enabled)
        {
            ...
            bool ret = executeNbddcGroupEnableCommand(_index, adjEnabled);
            if ( ret )
            {
                _enabled = adjEnabled;
        ...
        bool NbddcGroupComponent::setMembers(const BasicIntList& groupMembers)
        {
            ...
            bool ret = this->executeNbddcGroupCommand(_index, adjMembers);
            if (ret)
            {
        ...
        void NbddcGroupComponent::initConfigurationDict()
        {
            ...
            _config["members"] = "";
            //this->debug("[NbddcGroupComponent::initConfigurationDict] Current configuration\n");
        ...
        void NbddcGroupComponent::updateConfigurationDict()
        {
            ...
            //this->debug("[NbddcGroupComponent::updateConfigurationDict] Current configuration\n");
            //this->dumpConfiguration();
